...
<div className="five-minutes-div">
    ...
    <div className="director-div flex xl:px-48 xl:pt-24">
        <div className="flex flex-col justify-around items-center xl:px-64">
            ...
            <p className="text-sm text-center lg:text-2xl"><strong>Jason Mills,</strong> Director of Sales and Success</p>
        </div>
        <div className="">
            <img src="./images/man-pic.png" className="man-img w-full  h-auto bg-indigo-700"  />       
        </div>
    </div>


    <div className="how-it-works-container xl:px-64 xl:pt-32">
        <div className="how-it-works flex flex-col justify-evenly items-center px-4">
            ...
            <p className="text-center text-lg lg:pb-8 xl:pb-12">When a user dials in to the number we provide you,<br/> they will be asked:</p>
        </div>
        ...
        <div className="flex flex-col justify-center items-center md:px-36 md:flex-row px-4 py-4 ">
            ...
            <div classNName="pl-4">
                ...
                <p className="text-base">Dear will immediately receive an SMS text<br/>that tells you how long it will take to receive call back.</p>
            </div>
        </div>
        ...
        <div className="btn text-center pt-4 xl:py-12 xl:mb-12">
